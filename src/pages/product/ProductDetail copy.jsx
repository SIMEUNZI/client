            ...
            <div class="col-lg-8 col-xl-9">
              <div class="row g-12">
                ...
                <div class="col-lg-6">
                  ...
                  <a href="#" class="btn border border-secondary rounded-pill px-4 py-2 mb-4 text-primary"><i class="me-2 text-primary"><HeartIcon /></i> 구입하기 </a>
                </div>
                <div class="col-lg-12">
                  <nav>
            ...
            <div className="rounded position-relative fruite-item">
              ...
              <div className="p-4 border border-secondary border-top-0 rounded-bottom">
                ...
                <div className="d-flex justify-content-between flex-lg-wrap">
                  <p className="text-dark fs-5 fw-bold mb-0">{product.finalprice}</p>
                  <a href="#" className="btn border border-secondary rounded-pill px-3">
                    <i className="me-2 text-primary"><HeartIcon /> 구매하기</i>
                  </a>
                </div>
              </div>
            </div>
